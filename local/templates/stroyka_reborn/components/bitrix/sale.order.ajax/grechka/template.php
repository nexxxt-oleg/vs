    ...
    <section class="page-all-sect page-ordering__order">
        <div class="container">
            ...
            <div class="row">
                                ...
                                <div class="bx-soa">
                                        ...
                                        <div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
                                            <div class="bx-soa-section-title-container">
                                                ...
                                                <div class="col-12 col-sm-3 text-right">
                                                    <a href="/personal/cart/" onclick="window.location.href = '/personal/cart/'">Изменить заказ</a>
                                                </div>
                                            </div>
                                            <div class="bx-soa-section-content container-fluid"></div>
                                        </div>
                                    ...
                                    <div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
                                        <div class="bx-soa-section-title-container">
                                            ...
                                            <div class="col-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?= $arParams['MESS_EDIT'] ?></a>
                                            </div>
                                        </div>
                                        <div class="bx-soa-section-content container-fluid"></div>
                                    </div>
                                    ...
                                    <? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
                                        ...
                                        <div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active">
                                            <div class="bx-soa-section-title-container">
                                                ...
                                                <div class="col-12 col-sm-3 text-right"><a href=""
                                    ...
                                    <? if ($arParams['BASKET_POSITION'] === 'after'): ?>
                                        ...
                                        <div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
                                            <div class="bx-soa-section-title-container">
                                                ...
                                                <div class="col-12 col-sm-3 text-right"><a href="javascript:void(0)"
                                                                                           class="bx-soa-editstep"><?= $arParams['MESS_EDIT'] ?></a>
                                                </div>
                                            </div>
                                            <div class="bx-soa-section-content container-fluid"></div>
                                    ...
                                    <div id="bx-soa-orderSave">
                                        ...
                                        <a href="javascript:void(0)" style="margin: 10px 0"
                                           class="btn btn_color_ac" data-save-button="true">
                                            <?= $arParams['MESS_ORDER'] ?>
                                        </a>
                                    </div>
                ...
                <div class="order-0 order-sm-1 col-sm-4 col-lg-3">
                    <!--	SIDEBAR BLOCK	-->
                    <div class="page-ordering__right-block po-price-block" id="bx-soa-total">
                        <div class="bx-soa-cart-total-ghost"></div>
                        <div class="bx-soa-cart-total"<?= $arResult['ORDER_PRICE'] == 0 ? 'hidden' : '' ?>></div>
                    </div>
                </div>
            </div>
<? } ?>
