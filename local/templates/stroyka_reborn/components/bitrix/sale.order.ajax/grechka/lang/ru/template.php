...
$MESS["SOA_MANAGER"] = "рассчитывается<br/>менеджером";
...
$MESS["SOA_ORDER_SUC"] = "Ваш заказ №#ORDER_ID# от #ORDER_DATE#";
...
$MESS["SOA_ORDER_SUC2"] = "Вы можете  отслеживать выполнение заказа <br> в Вашем личном кабинете";
$MESS["SOA_ORDER_SUC3"] = "Вы можете следить за выполнением своего заказа в Персональном разделе сайта. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";
$MESS["SOA_ORDER_SUC4"] = "Успешно создан";
