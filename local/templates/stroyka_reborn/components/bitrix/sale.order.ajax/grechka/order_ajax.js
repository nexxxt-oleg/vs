    ...
    BX.Sale.OrderAjaxComponent = {
            ...
            node.appendChild(
                BX.create('DIV', {
                    ...
                    children: [
                        BX.create('DIV', {
                            props: {
                                className: 'bx-soa-more-btn col-12'
                            },
                            children: buttons
                        })
                    ]
            ...
            authContent.appendChild(
                BX.create('DIV', {
                    ...
                    children: [
                        BX.create('DIV', {
                            props: {
                                className: 'bx-soa-reference col-12'
                            },
                            children: [
            ...
            section.appendChild(
                BX.create('DIV', {
                    ...
                    children: [
                        BX.create('h2', {
                            props: {
                                className: 'bx-soa-section-title col-7 col-sm-9'
                            },
        ...
        editPaySystemItems: function (paySystemNode) {
            ...
            var paySystemItemsContainer = BX.create('DIV', {
                    props: {
                        className: 'col-sm-7 bx-soa-pp-item-container'
                    }
                }),
                paySystemItemNode, i;
        ...
        createPaySystemItem: function (item) {
            ...
            itemNode = BX.create('DIV', {
                props: {
                    className: 'bx-soa-pp-company col-lg-4 col-6'
                },
        ...
        editDeliveryInfo: function (deliveryNode) {
            ...
            infoList = BX.create('UL', {
                props: {
                    className: 'bx-soa-pp-list d-none'
                },
            ...
            if (item.PRICE >= 0 || typeof item.DELIVERY_DISCOUNT_PRICE !== 'undefined') {
                if (item.ID != 2) {
                    labelNodes.push(
                        BX.create('DIV', {
                            props: {
                                className: 'bx-soa-pp-delivery-cost d-none'
                            },
        ...
        editFadeDeliveryContent: function (node) {
            ...
            if (selectedDelivery && selectedDelivery.NAME) {
                ...
                node.appendChild(
                    BX.create('DIV', {
                        props: {
                            className: 'col-sm-3 bx-soa-pp-price d-none'
                        },
                    ...
                    BX.create('DIV', {
                        ...
                        children: [
                            BX.create('A', {
                                props: {
                                    href: '',
                                    className: 'btn btn_color_grey-2'
                                },
        ...
        editTotalBlock: function () {
            ...
            } else if (curDelivery.ID == 2) {
                deliveryValue = BX.message('SOA_MANAGER');
            } else {
