	...
	<section class="page-all-sect page-ordering__order">
		<div class="container">
			...
			<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
				...
				?>
				<div class="row">
					<div class="order-1 order-sm-0 col-sm-8 col-lg-8">
						...
						<div id="bx-soa-order" class="bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
							...
							<!--	AUTH BLOCK	-->
							<div id="bx-soa-auth" class="page-ordering__card card-head-grey bx-soa-auth" style="display:none">
								<div class="card-head-grey__head">
									<h4 class="card-head-grey__title"><?=$arParams['MESS_AUTH_BLOCK_NAME']?></h4>
								</div>
								<div class="card-head-grey__content"></div>
							</div>
							...
							<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
								<!--	BASKET ITEMS BLOCK	-->
								<div id="bx-soa-basket" data-visited="false" class="page-ordering__card card-head-grey bx-active">
									<div class="card-head-grey__head">
										<h4 class="card-head-grey__title"><?=$arParams['MESS_BASKET_BLOCK_NAME']?></h4>
										<a href="" class="card-head-grey__edit"><?=$arParams['MESS_EDIT']?></a>
									</div>
									<div class="card-head-grey__content"></div>
								</div>
							<? endif ?>
							...
							<!--	REGION BLOCK	-->
							<div id="bx-soa-region" data-visited="false" class="page-ordering__card card-head-grey bx-active">
								<div class="card-head-grey__head">
									<h4 class="card-head-grey__title"><?=$arParams['MESS_REGION_BLOCK_NAME']?></h4>
									<a href="" class="card-head-grey__edit"><?=$arParams['MESS_EDIT']?></a>
								</div>
								<div class="card-head-grey__content"></div>
							</div>
							...
							<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
								<!--	PAY SYSTEMS BLOCK	-->
								<div id="bx-soa-paysystem" data-visited="false" class="page-ordering__card card-head-grey bx-active">
									<div class="card-head-grey__head">
										<h4 class="card-head-grey__title"><?=$arParams['MESS_PAYMENT_BLOCK_NAME']?></h4>
										<a href="" class="card-head-grey__edit"><?=$arParams['MESS_EDIT']?></a>
									</div>
									<div class="card-head-grey__content"></div>
								</div>
								<!--	DELIVERY BLOCK	-->
								<div id="bx-soa-delivery" data-visited="false" class="page-ordering__card card-head-grey bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
									<div class="card-head-grey__head">
										<h4 class="card-head-grey__title"><?=$arParams['MESS_DELIVERY_BLOCK_NAME']?></h4>
										<a href="" class="card-head-grey__edit"><?=$arParams['MESS_EDIT']?></a>
									</div>
									<div class="card-head-grey__content"></div>
								</div>
								<!--	PICKUP BLOCK	-->
								<div id="bx-soa-pickup" data-visited="false" class="page-ordering__card card-head-grey" style="display:none">
									<div class="card-head-grey__head">
										<h4 class="card-head-grey__title"></h4>
										<a href="" class="card-head-grey__edit"><?=$arParams['MESS_EDIT']?></a>
									</div>
									<div class="card-head-grey__content"></div>
								</div>
							...
							<? endif ?>
							<!--	BUYER PROPS BLOCK	-->
							<div id="bx-soa-properties" data-visited="false" class="page-ordering__card card-head-grey bx-active">
								<div class="card-head-grey__head">
									<h4 class="card-head-grey__title"><?=$arParams['MESS_BUYER_BLOCK_NAME']?></h4>
									<a href="" class="card-head-grey__edit"><?=$arParams['MESS_EDIT']?></a>
								</div>
								<div class="card-head-grey__content"></div>
							</div>
							...
							<? if ($arParams['BASKET_POSITION'] === 'after'): ?>
								...
								<div id="bx-soa-basket" data-visited="false" class="page-ordering__card card-head-grey bx-active">
									<div class="card-head-grey__head">
										<h4 class="card-head-grey__title"><?=$arParams['MESS_BASKET_BLOCK_NAME']?></h4>
										<a href="javascript:void(0)" class="card-head-grey__edit"><?=$arParams['MESS_EDIT']?></a>
									</div>
									<div class="card-head-grey__content"></div>
								</div>
							<? endif ?>
							...
							<div id="bx-soa-orderSave">
								...
								<a href="javascript:void(0)" style="margin: 10px 0" class="btn btn_color_ac po-cards-btm__next-btn" data-save-button="true">
									<?=$arParams['MESS_ORDER']?>
								</a>
							</div>

							<div style="display: none;">
								<div id='bx-soa-basket-hidden' class="card-head-grey"></div>
								<div id='bx-soa-region-hidden' class="card-head-grey"></div>
								<div id='bx-soa-paysystem-hidden' class="card-head-grey"></div>
								<div id='bx-soa-delivery-hidden' class="card-head-grey"></div>
								<div id='bx-soa-pickup-hidden' class="card-head-grey"></div>
								<div id="bx-soa-properties-hidden" class="card-head-grey"></div>
								<div id="bx-soa-auth-hidden" class="card-head-grey">
									<div class="card-head-grey__content reg"></div>
								</div>
							</div>
					...
					<!--	SIDEBAR BLOCK	-->
					<div id="bx-soa-total" class="order-0 order-sm-1 col-sm-3 col-lg-3 bx-soa-sidebar">
