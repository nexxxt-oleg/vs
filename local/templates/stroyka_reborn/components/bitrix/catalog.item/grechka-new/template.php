        ...
        <div class="card-product__top">
            <div class="card-product__badges">
                ...
                <? if ($item['MIN_PRICE']['DISCOUNT_DIFF_PERCENT']) : ?>
                    <span class="card-product__badge card-product__badge_discount card-product__badge_color_red">-<?= $item['MIN_PRICE']['DISCOUNT_DIFF_PERCENT'] ?>
                        %</span>
                <? elseif ($oldPrice):
                    $discountPercent = round(100 - ((int)$item['MIN_PRICE']['VALUE'] * 100 / $oldPrice));
                    ?>
                    <span class="card-product__badge card-product__badge_discount card-product__badge_color_red">-<?= $discountPercent ?>
                        %</span>
                <? elseif ($discount) : ?>
                    <span class="card-product__badge card-product__badge_discount card-product__badge_color_red">-<?= rtrim($discount, '%') ?>
                        %</span>
                <? endif; ?>
            </div>
            ...
            <? if ($isAuthoredUser): ?>
                <button class="card-product__add-favorites h2o_add_favor"
                        data-id="<?= $item["ID"] ?>">
            ...
            <? else: ?>
                ...
                ?>
                <a href="<?= $favoritesListUrl ?>" class="card-product__add-favorites">
