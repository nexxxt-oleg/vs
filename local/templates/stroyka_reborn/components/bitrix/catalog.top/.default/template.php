    ...
    <div class="new-row">
        <div class="new-col-lg-12">
            <div class="page-home__block-title">
                <span class="page-home__slider-title h2-new"><?= $arParams['TITLE'] ?? 'Всё со скидкой' ?></span>
                <?
                if (isset($arParams['PAGE_URL'])) :
                    $sectionUrl = $arParams['PAGE_URL'] ?: '/sale/';
                    ?>
                    <a href="<?= $sectionUrl ?>" class="page-home__slider-link">
                        <span>в раздел</span>
                        <span></span>
                    </a>
                <? endif; ?>
    ...
    <div class="new-row">
        <div class="col-no-padding new-col-lg-12">
            <div class="page-home__sale-slider sale-slider">
                <?
                $sliderClass = 'sale-slider__discount';
                if (isset($arParams['SLIDER_CLASS']))
                    $sliderClass = !empty($arParams['SLIDER_CLASS']) ? $arParams['SLIDER_CLASS'] : '';
                ?>
...
//                                'TYPE' => $rowData['TYPE'],
                                        'POP_PRODUCTS' => $arParams['POP_PRODUCTS'],
                                            'BIG_LABEL' => 'N',
