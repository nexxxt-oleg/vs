    ...
    <div class="new-row">
        <div class="new-col-lg-12">
            <div class="page-home__block-title">
                <span class="page-home__slider-title h2-new"><?= $arParams['TITLE'] ?? 'Уцененные товары' ?></span>
                <a href="/markdown/" class="page-home__slider-link">
                    <span>в раздел</span>
                    <span></span>
                </a>
            </div>
    ...
    <div class="new-row">
        <div class="col-no-padding new-col-lg-12">
            <div class="page-home__sale-slider sale-slider">
                <div class="sale-slider__discount">
