...
if ($showTopPager) {
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-catalog__top-navs top-navs row">
                <div class="col-sm-6 col-md-4 order-md-1">
                    <? $APPLICATION->IncludeComponent(
                        ...
                        Array(
                            "CACHE_TIME" => "36000000",
                            "CACHE_TYPE" => "A",
                            "FIELDS_CODE" => array("name", "sort", "created"),
                            "IBLOCK_ID" => "21",
                            "IBLOCK_TYPE" => "catalog",
...
<? if ($showLazyLoad) { ?>
    <div class="row ">
        <div class="btn btn_color_ac" style="margin: 15px;"
