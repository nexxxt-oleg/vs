...
if (!empty($arResult['ITEMS'])) :
    ...
    ?>
    <section class="p-search-result__sect search-result">
        <div class="new-container">
            <div class="new-row">
                <div class="new-col-lg-12">
                    <span class="search-result__title h2-new"><?= $APPLICATION->sDocTitle ?></span>
                </div>
                <div class="new-col-lg-12">
                    <div class="new-row">
                        <div class="search-result__wrap">
                            ...
                            <!-- <div class="new-col-12 new-col-sm-6 new-col-lg-5">
                                 <form class="search-result__form form-result">
                                     <input type="email" class="form-result__input" placeholder="Поиск среди найденного">
                                     <button class="form-result__btn" type="submit">
                                         <img src="img/ui-icon/search.svg" alt="" class="img-svg">
                                     </button>
                                 </form>
                                 <span class="search-result__cnt">Найдено: 20</span>
                             </div>-->
