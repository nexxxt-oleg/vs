		...
		if (!empty($arSource))
		{
			...
			?>
				<div>
					...
					{
                    if (in_array($arProperties["ID"], $arProp)) {
                        continue;
                    } else {
                        $arProp[] = $arProperties["ID"];
                    }
						?>
						...
						elseif ($arProperties["TYPE"] == "TEXT")
						{
							...
							<span class="ordering-form__label">
								<?=$arProperties["NAME"]?>
							</span>
						...
						elseif ($arProperties["TYPE"] == "TEXTAREA")
						{
							...
							?>
                            <div class="ordering-form__point-block">
                                <span class="ordering-form__label">
                                    <?=$arProperties["NAME"]?>
                                </span>
						...
						elseif ($arProperties["TYPE"] == "LOCATION2")
						{
							?>
							<div class="bx_block r1x3 pt8">
								<?=$arProperties["NAME"]?>
