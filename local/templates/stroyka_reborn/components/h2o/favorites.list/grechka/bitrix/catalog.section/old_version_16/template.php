...
<? if (!empty($arResult['ITEMS'])) {
    ...
    if (!empty($arResult['SKU_PROPS'])) {
        foreach ($arResult['SKU_PROPS'] as $arProp) {
            ...
            if ('TEXT' == $arProp['SHOW_MODE']) {
                $skuTemplate[$propId]['SCROLL']['START'] =
                    '<div class="bx_item_detail_size full" id="#ITEM#_prop_' . $propId . '_cont">' .
                    '<span class="bx_item_section_name_gray">' . htmlspecialcharsbx($arProp['NAME']) . '</span>' .
                    '<div class="bx_size_scroller_container">' .
                    '<div class="bx_size"><ul id="#ITEM#_prop_' . $propId . '_list" style="width: #WIDTH#;">';;
    ...
    <? // СЕКЦИЯ С КАРТОЧКАМИ ТОВАРОВ НАЧИНАЕТСЯ ТУТ  ?>

    <div class="new-row ajax-h2ofavorites-items">
        <? foreach ($arResult['ITEMS'] as $key => $arItem) {
            ...
            ?>
            <div class="col-no-padding new-col-6 new-col-sm-4 new-col-lg-2" id="<? echo $strMainID; ?>">
                <div class="card-wraper p-search-result__card-wraper">
                    <div class="card-product">
                        <div class="card-product__top">
                            <div class="card-product__badges">
                                <span class="card-product__badge card-product__badge_color_green d-none">Новинка</span>
                                ...
                                <div class="card-product__badge card-product__badge_markdown card-product__badge_color_violet d-none">
                                    ...
                                    <div class="card-product__markdown-wrap">
                                        <span class="card-product__markdown">До недавнего недавнего недавнего недавнего недавнегонедавнего недавнего времени считалось, что рейт-карта концентрирует социометрический креатив, учитывая современные тенденции.</span>
                                    </div>
                                </div>
                                <span class="card-product__badge card-product__badge_discount card-product__badge_color_red d-none">-30%</span>
                            </div>
                            ...
                            <button class="card-product__add-favorites added delete_favorites"
                                    data-id="<?= $arItem['ID'] ?>">
                        ...
                        <div class="card-product__middle">
                            <div class="card-product__price">
                                <span class="card-product__current-price"
                                      id="<? echo $arItemIDs['PRICE']; ?>">912 265 ₽</span>
                                <? if (!empty($minPrice)) {
                                ...
                                </span><span class="card-product__discount"><? echo $minPrice['PRINT_VALUE']; ?>
                                    <? }
                                    }
                                    unset($minPrice); ?>
                                        </span>
                            ...
                            <a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
                               class="card-product__info"><? echo $productTitle; ?></a>
                            <div class="card-product__code">
                                <span>Код:</span>
                                <span><?= $arItem['PROPERTIES']['CML2_TRAITS']['VALUE']['2'] ?></span>
                            </div>
                        </div>
                        <div hidden>
                            <? if ($arItem['CAN_BUY']) { ?>
                                <div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>"
                                     class="card-product__basket-block">
                                    <a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="card-product__add-cart"
                        ...
                        <div class="card-product__bottom" hidden>
                            <div class="card-product__block-cnt block-cnt">
                                <button class="block-cnt__minus"></button>
                                <input class="block-cnt__field" id="" type="number" value="1">
                                <button class="block-cnt__plus"></button>
                            </div>
                            <button class="card-product__basket">
