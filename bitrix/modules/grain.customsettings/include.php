		...
		?>
			<?if(self::IsLinksInstalled()):?>
				...
				<label><table cellspacing="0" cellpadding="0"><tr>
					<td><?=GetMessage("GRAIN_CUSTOMSETTINGS_OPTIONS_SETTINGS_LINK_INTERFACE_MULTIPLE")?></td>
					<td><input type="checkbox" name="TABS[<?=$gks_tab_id?>][FIELDS][<?=$gks_option_id?>][MULTIPLE]" value="Y"<?if($option["MULTIPLE"]=="Y"):?> checked="checked"<?endif?> /></td>
				</tr></table></label>
				<label><table cellspacing="0" cellpadding="0"><tr>
