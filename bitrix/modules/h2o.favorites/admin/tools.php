...
class H2oFavoritesTools{
	...
	static public function ShowUserField($name, $property_fields, $values, $form_name = "favorites_edit_form", $bCopy = false){
