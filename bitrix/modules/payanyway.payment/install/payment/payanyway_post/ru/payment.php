...
$MESS['PAW_INVOICE_CREATED']			= '<p>Операция оплаты почтовым переводом создана и находится в обработке. Для завершения операции <a target="_blank" href="https://%payment_server%/mailofrussiablank.htm?operationId=%operation%&transactionId=%ctid%">распечатайте</a> бланк почтового перевода и проведите электронный платеж в любом отделении связи <a target="_blank" href="http://www.russianpost.ru">Почты России</a>. Для просмотра бланка в формате PDF необходимо иметь установленную на Вашем компьютере программу <a target="_blank" href="http://get.adobe.com/reader/">Adobe Acrobat Reader.</a></p>';
