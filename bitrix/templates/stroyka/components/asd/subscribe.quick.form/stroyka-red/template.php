...
?>
<form action="<?= POST_FORM_ACTION_URI?>" method="post" id="asd_subscribe_form_red">
	<?= bitrix_sessid_post()?>
...
<!--	<input type="submit" name="asd_submit" id="asd_subscribe_submit" value=" " />-->
	<div class="btn-more-information asd_subscribe_submit">
		<span class="btn-more-information-arrow">Подписаться</span>
		<div class="btn-more-information-arrow-figure"></div>
	</div>
	<?if (isset($arResult['RUBRICS'])):?>
		...
		<?endforeach;?>
	<?endif;?>
<div class="asd_subscribe_res" style="display: none;position:relative;"></div>
</form>